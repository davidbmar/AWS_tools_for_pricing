...
def extract_data(domain_details):
      ...
      for detail in domain_details:
            if detail:
               # Master node details
               dedicated_master_enabled = detail['ClusterConfig'].get('DedicatedMasterEnabled', False)
               dedicated_master_type = detail['ClusterConfig'].get('DedicatedMasterType', 'N/A')
               dedicated_master_count = detail['ClusterConfig'].get('DedicatedMasterCount', 'N/A')
               
               # Data node details
               data_node_instance_type = detail['ClusterConfig']['InstanceType']
               data_node_instance_count = detail['ClusterConfig']['InstanceCount']
